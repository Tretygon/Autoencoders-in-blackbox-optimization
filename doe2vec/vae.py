...
class VAE(tf.keras.Model):
    ...
    def __init__(self, latent_dim, sample_size, kl_weight=0.1):
        ...
        self.arch = [4*latent_dim, 2*latent_dim]
    ...
    def _encoder(self):
        ...
        x = layers.Dense(self.arch[0], activation="relu")(encoder_inputs)
        x = layers.Dense(self.arch[1], activation="relu")(x)
    ...
    def _decoder(self):
        ...
        x = layers.Dense(self.arch[1], activation="relu")(latent_inputs)
        x = layers.Dense(self.arch[0], activation="relu")(x)
